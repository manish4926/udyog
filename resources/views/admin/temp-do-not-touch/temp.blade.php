      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{asset('admin/pages/examples/pace.html')}}"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="{{asset('admin/pages/examples/invoice.html')}}">OR9842</a></td>
                  ...
                  <tr>
                    <td><a href="{{asset('admin/pages/examples/invoice.html')}}">OR1848</a></td>
                  ...
                  <tr>
                    <td><a href="{{asset('admin/pages/examples/invoice.html')}}">OR7429</a></td>
                    <td>iPhone 6 Plus</td>
