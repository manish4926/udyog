...
<table border="0" cellpadding="5" cellspacing="0">
	...
	<label for="mob"><b>Mobile *</b></label><br />
	<input name="mob" type="text" maxlength="50" style="width: 260px" />
	</td>
	<tr> <td colspan="2">
	...
	<input type="submit" class="btn btn-primary" value="Send Application" name="submit" style="padding:5px 120px 5px 5px ">
	</td> </tr>
</table>
</form>
</div>
